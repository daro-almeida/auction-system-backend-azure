...
// public static AuctionItem auctionToItem(AuctionDAO auction, Optional<BidDAO>
// topBid) {
...
// case DELETED -> throw new IllegalArgumentException("Cannot convert deleted
...
// Optional.ofNullable(question.getReply()).map(r ->
// DAO.replyToItem(question.getId(), r)));
// }

// public static ReplyItem replyToItem(String questionId, QuestionDAO.Reply
// reply) {
...
// if (user.getStatus() == UserDAO.Status.DELETED) {
// return new UserItem(
// AzureLogic.DELETED_USER_ID,
// AzureLogic.DELETED_USER_NAME,
// Optional.empty());
// } else {
// return new UserItem(
// user.getId(),
