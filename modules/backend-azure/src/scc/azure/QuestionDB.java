...
class QuestionDB {
    ...
    public Optional<QuestionDAO> getQuestion(String questionId) {
        var options = this.createQuestionQueryOptions(questionId);
    ...
    public Result<QuestionDAO, ServiceError> createReply(String questionId, QuestionDAO.Reply reply) {
        ...
        var partitionKey = this.createQuestionPartitionKey(questionId);
    ...
    public List<QuestionDAO> listQuestions(String auctionId) {
        var options = this.createQuestionQueryOptions(auctionId);
        return this.container
                .queryItems(
     ...
     */
    private PartitionKey createQuestionPartitionKey(String questionId) {
     ...
     */
    private CosmosQueryRequestOptions createQuestionQueryOptions(String questionId) {
        var options = new CosmosQueryRequestOptions();
        options.setPartitionKey(this.createQuestionPartitionKey(questionId));
        return options;
    }
